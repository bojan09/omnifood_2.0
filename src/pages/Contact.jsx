...
import formImage from "../assets/bowls.jpg";

const Contact = () => {
  return (
    <div
      id="contact"
      className=" xs:w-[90vw] md:w-[82vw] lg:w-[60vw] lg:h-[60vh] flex md:flex-row xs:flex-col-reverse rounded-lg mx-auto bg-gradient-to-br from-primaryColor to-shadeColor"
    >
      <div className="m-6">
        {/* Left container - Form*/}
        ...
        <form className="font-sm text-lg">
          ...
          <div className="md:flex gap-3 items-center justify-center">
            ...
            <div className="flex-1 flex justify-center items-center mt-9 text-center">
              <button
                className=" bg-darkColor  rounded-md hover:bg-shadeColor hover:border-[2px] border-yellow-100 text-white font-medium transition-all duration-200 ease-in-out py-[.4rem] xs:px-6 lg:px-[5rem] md:px-[3rem] md:mt-[2rem] lg:mt-0"
                type="submit"
              >
                Sign up now
              </button>
